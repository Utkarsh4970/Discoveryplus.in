...
function Newly() {
    ...
    return (
        <Toolbar>
            ...
            <h1 className='pt-3' style={{ fontSize: "20px", color: "white" }}>Newly Added Shows<Link to="/showall" className='float-end pt-0 hov' style={{ color: "#838991", fontSize: "16px", textDecoration: "none" }}>View All</Link></h1>
                <div className="row">
                    {
                        newly.map((e) => (
